    ...
    function initRecorderDom(){
        ...
        function initToolsPannel(){
            ...
            var arrHTML = [
                ...
                // add by 61
                '<div><span class="uirecorder-button"><a name="uirecorder-setup"><img src="'+baseUrl+'img/jscode.png" alt="">'+__('button_setup_on_text')+'</a></span><span class="uirecorder-button"><a name="uirecorder-export-file-expect"><img src="'+baseUrl+'img/expect.png" alt="">'+__('button_export_file_expect_text')+'</a></span><span class="uirecorder-button"><a name="uirecorder-hover"><img src="'+baseUrl+'img/hover.png" alt="">'+__('button_hover_on_text')+'</a></span><span class="uirecorder-button"><a name="uirecorder-expect"><img src="'+baseUrl+'img/expect.png" alt="">'+__('button_expect_text')+'</a></span><span class="uirecorder-button"><a name="uirecorder-vars"><img src="'+baseUrl+'img/vars.png" alt="">'+__('button_vars_text')+'</a></span><span class="uirecorder-button"><a name="uirecorder-jscode"><img src="'+baseUrl+'img/jscode.png" alt="">'+__('button_jscode_text')+'</a></span><span class="uirecorder-button"><a name="uirecorder-sleep"><img src="'+baseUrl+'img/sleep.png" alt="">'+__('button_sleep_text')+'</a></span><span class="uirecorder-button"><a name="uirecorder-jump"><img src="'+baseUrl+'img/jump.png" alt="">'+__('button_jump_text')+'</a></span><span class="uirecorder-button"><a name="uirecorder-end"><img src="'+baseUrl+'img/end.png" alt="">'+__('button_end_text')+'</a></span></div>',
                ...
                if(parentNode && parentNode.id === 'uirecorder-attrs'){
                    ...
                    switch(name){
                        ...
                        case 'uirecorder-sleep':
                            ...
                            break;
                        // add by 61
                        case 'uirecorder-setup':
                            showSetupDailog();
                            break;
                        // add by 61
                        case 'uirecorder-export-file-expect':
                            showExportFileExpectDailog();
                            break;
            ...
            // add by 61
            function showSetupDailog(){
                var strHtml = '<ul><li><label>'+__('dialog_setup_cmd')+'</label><input type="text"value="初始化自动化测试环境" placeholder="'+__('dialog_setup_cmd_tip')+'" id="uirecorder-setupcmd"></li></ul>';
                setGlobalWorkMode('pauseAll');
                var domSetupCmd;
                showDialog(__('button_setup_title'), strHtml, {
                    onInit: function(){
                        domSetupCmd = document.getElementById('uirecorder-setupcmd');
                        domSetupCmd.select();
                        domSetupCmd.focus();
                    },
                    onOk: function(){
                        var setupCmd = domSetupCmd.value;
                        // if(/\w+/.test(setupCmd)){
                        saveCommand('setup', setupCmd);
                        hideDialog();
                        setGlobalWorkMode('record');
                        // }
                        // else{
                        //     domSetupCmd.focus();
                        //     alert('dialog_setup_cmd_tip');
                        // }
                    },
                    onCancel: function(){
                        setGlobalWorkMode('record');
            ...
            // add by 61
            function showExportFileExpectDailog(expectTarget, callback){
                var arrHtmls = [
                    '<ul>',
                    '<li id="uirecorder-export-file-expect-test-name"><label>'+__('dialog_export_file_expect_test_name')+'</label><input id="uirecorder-export-file-expect-test-name-input" type="text" /></li>',
                    '<li id="uirecorder-export-file-expect-config-file"><label>'+__('dialog_export_file_expect_config_file')+'</label><input id="uirecorder-export-file-expect-config-file-input" type="text" /></li>',
                    '<li id="uirecorder-export-file-expect-config-section"><label>'+__('dialog_export_file_expect_config_section')+'</label><input id="uirecorder-export-file-expect-config-section-input" type="text" /></li>',
                    '<li><label>'+__('dialog_export_file_expect_type')+'</label><select id="uirecorder-export-file-expect-type"><option>Excel</option><option>Text File</option><option>Zip File</option></select></li>',
                    '</ul>'
                ];
                var domExpectConfigFile, domExpectConfigSection, domExpectType,domExpectTestName;
                showDialog(__('dialog_export_file_expect_title'), arrHtmls.join(''), {
                    onInit: function(){
                        // 初始化dom及事件
                        domExpectTestName = document.getElementById('uirecorder-export-file-expect-test-name-input');
                        domExpectConfigFile = document.getElementById('uirecorder-export-file-expect-config-file-input');
                        domExpectConfigSection = document.getElementById('uirecorder-export-file-expect-config-section-input');
                        domExpectType = document.getElementById('uirecorder-export-file-expect-type');
                    },
                    onOk: function(){
                        var configFile = domExpectConfigFile.value;
                        var configSection = domExpectConfigSection.value;
                        var expectType = domExpectType.value;
                        var testName = domExpectTestName.value;
                        var dicParams = {};
                        dicParams={
                        ...
                        saveCommand('export file expect', dicParams);
                        hideDialog();
                        setGlobalWorkMode('record');
                    },
                    onCancel: function(){
